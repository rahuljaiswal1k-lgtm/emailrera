          ...
          return (
            <div key={box.id} className="rounded-xl border border-gray-200 p-3">
              <div className="flex items-center justify-between mb-2">
                <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wide">{preset.label}</span>
              ...
              {box.kind !== 'quote' && (
                <FieldGroup label="Icon" hint="Optional — leave unselected for no icon">
